...
public class PhilosopheMalin implements Runnable{
	...
	private boolean mangerRecemment;
	...
	private void manger() {
		if(baguetteDroite && baguetteGauche) {
			...
			this.gauche.poser();
			this.baguetteGauche=false;
			this.mangerRecemment=true;
		}else if(this.mangerRecemment) {
			if(baguetteDroite) {
				//System.out.println("Je pose manger recemment");
				this.droite.poser();
				this.mangerRecemment=false;
			}else if(baguetteGauche){
				//System.out.println("Je pose manger recemment");
				this.gauche.poser();
				this.mangerRecemment=false;
			}
